...
export declare type WssFactoryFn = (path: string, retryTimeoutMs?: number) => SmartWss;
...
export declare abstract class BasicClient extends EventEmitter implements IClient {
    ...
    constructor(wssPath: string, name: string, wssFactory?: WssFactoryFn, watcherMs?: number, retryTimeoutMs?: number);
    close(): void;
    reconnect(): void;
