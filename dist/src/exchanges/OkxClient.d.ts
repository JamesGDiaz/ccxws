...
export declare type OkxClientOptions = ClientOptions & {
 ...
 */
export declare class OkxClient extends BasicClient {
    candlePeriod: CandlePeriod;
    protected _sendMessage: CancelableFn;
    protected _pingInterval: NodeJS.Timeout;
    constructor({ wssPath, watcherMs, sendThrottleMs, }?: OkxClientOptions);
