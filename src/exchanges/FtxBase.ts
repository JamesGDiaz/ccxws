...
export class FtxBaseClient extends BasicClient {
    ...
    protected _tickerMessageHandler(data, market: Market) {
    ...
    protected _tradesMessageHandler(data, market: Market) {
    ...
    protected _orderbookMessageHandler(data, market, type) {
